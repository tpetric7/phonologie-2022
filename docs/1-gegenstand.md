...
::: rmdnote
*`Äußerungen`* lassen sich als Laut- oder Schriftzeichenketten
definieren, die von einem Sprecher zwischen zwei Pausen produziert
werden und aus einem oder mehreren Sätzen bestehen können.
\[@bussmann1990lexikon: 52\] Im Gegensatz zu Sätzen sind sie
*`kommunikative`* Einheiten und gehören somit auf die Ebene der
*`Performanz`* oder Parole.
:::
